...
import { computeCohortPercent, flattenModuleWeeks, getCompletedStepIds } from "@/lib/module-progress";
...
export default async function LearnProtectedLayout({ children }: { children: React.ReactNode }) {
  ...
  const modules = application.cohort!.modules.map(flattenModuleWeeks);
